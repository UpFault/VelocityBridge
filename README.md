...
| --------- | ------------------------------------------------ | --------------------------- | ----------------------------------- | ---------------------------------- |
| blacklist | Blacklists specified user from using bot.        | `/blacklist [arg] [player]` | `/blacklist add UpFault`     | ![](https://imgur.com/Ybaj9wj.png) |
| demote    | Demotes the given user by one guild rank.        | `/demote [player]`          | `/demote UpFault`            | ![](https://imgur.com/liHDaOW.png) |
...
| invite    | Invites the specified user to the guild.         | `/invite [player]`          | `/invite UpFault`            | ![](https://imgur.com/DIfzSS7.png) |
| kick      | Kicks the specified user from the guild.         | `/kick [player] [reason]`   | `/kick UpFault`              | ![](https://imgur.com/auMbSD9.png) |
| mute      | Mutes the given user for a given amount of time. | `/mute [player] [time]`     | `/mute UpFault 1h`           | ![](https://imgur.com/fQxoyHv.png) |
| online    | View online player in the guild.                 | `/online`                   | `/online`                           | ![](https://imgur.com/Ny4vTRQ.png) |
| execute   | Executes commands as the minecraft bot.          | `/execute [command]`        | `/execute /g unmute UpFault` | ![](https://imgur.com/fBi2Bv2.png) |
| ping      | Shows the latency of the bot.                    | `/ping`                     | `/ping`                             | ![](https://imgur.com/9sHFgGT.png) |
| promote   | Promotes the specified user by 1 rank.           | `/promote [player]`         | `/promote UpFault`           | ![](https://imgur.com/wmMWP5b.png) |
| unmute    | Unmutes the given user.                          | `/unmute [player]`          | `/unmute UpFault`            | ![](https://imgur.com/nlu8lo6.png) |
...
| auction     | Active Auctions of specified user.          | `!auction [player]`       | `!auction UpFault`  | `UpFault's Active Auctions » https://i.imgur.com/9Jw8zCK.png` |
...
| duels       | Duel stats of specified user.               | `!duels [player]`         | `!duels UpFault`    | `[Duels] [Godlike II] UpFault Wins: 27044 CWS: 6 BWS: 536 WLR: 4.95` |
...
| guildexp    | Guilds experience of specified user.        | `!guildexp [player]`      | `!guildexp UpFault` | `Your Weekly Guild Experience » 1,495` |
...
| monthly     | Get monthly stats of specified user.        | `!monthly [player]`       | `!monthly UpFault`  | `UpFault has gained 0 karma and gained 0.1 levels in the last month.` |
...
| render      | Renders item of specified user.             | `!render [player] [slot]` | `!render UpFault`   | `UpFault's item at slot 1 » https://i.imgur.com/U2dIcSc.png` |
| skills      | Skills and Skill Average of specified user. | `!skills [player]`        | `!skills UpFault`   | `Skill Average » 54.44 Farming - 60.00 Mining - 60.00 Combat - 60.00 Enchanting - 60.00 Fishing - 50.00 Foraging - 50.00 Alchemy - 50.00 Taming - 50.00 Carpentry - 50.00` |
| skywars     | Skywars stats of specified user.            | `!skywars [player]`       | `!skywars UpFault`  | `[38✫] Refraction KDR: 6.04 WLR: 1.01 WS: 0` |
...
| UHC         | UHC Stats of specified user.                | `!UHC [player]`           | `!UHC UpFault`      | `[6✫] Refraction KDR: 2.54 WLR: 69 Heads: 578` |
| weight      | Skyblock Stats of specified user.           | `!weight [player]`        | `!weight UpFault`   | `Refraction's Senither Weight » 27721.82 Skills: 12991.95 Dungeons: 11353.90` & `Refraction's Lily Weight » 28342.24 Skills » 12310.84 Slayer » 4476.85 Dungeons » 11554.55` |
| woolwars    | WoolWars stats of specified user.           | `!woolwars [player]`      | `!woolwars UpFault` | `[2✫] UpFault » W: 5 WLR: 0.5 KDR: 1.19 BB: 37 WP: 45` |
